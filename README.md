...
This repository provides a summary of recent advancements in the security landscape surrounding **Neural Code Models (NCMs)**, including **backdoor**, **adversarial attacks**, **corresponding defenses** and so on.
